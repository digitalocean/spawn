...
log_info "Plandex on Netcup VPS"
echo ""

# 1. Resolve Netcup API credentials
...
run_server "${NETCUP_SERVER_IP}" "curl -sL https://plandex.ai/install.sh | bash"
...
sleep 1
clear
interactive_session "${NETCUP_SERVER_IP}" "source ~/.zshrc && plandex"
