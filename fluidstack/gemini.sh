...
log_info "Gemini CLI on FluidStack"
echo ""
...
run_server "${FLUIDSTACK_SERVER_IP}" "npm install -g @google/gemini-cli"
...
sleep 1
clear
interactive_session "${FLUIDSTACK_SERVER_IP}" "source ~/.zshrc && gemini"
