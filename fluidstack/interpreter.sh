...
log_info "Open Interpreter on FluidStack"
echo ""
...
run_server "${FLUIDSTACK_SERVER_IP}" "pip install open-interpreter 2>/dev/null || pip3 install open-interpreter"
...
sleep 1
clear
interactive_session "${FLUIDSTACK_SERVER_IP}" "source ~/.zshrc && interpreter"
