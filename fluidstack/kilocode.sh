...
log_info "Kilo Code on FluidStack"
echo ""
...
run_server "${FLUIDSTACK_SERVER_IP}" "npm install -g @kilocode/cli"
...
sleep 1
clear
interactive_session "${FLUIDSTACK_SERVER_IP}" "source ~/.zshrc && kilocode"
