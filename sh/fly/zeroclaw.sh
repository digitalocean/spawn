...
if [[ -n "$SCRIPT_DIR" && -f "$SCRIPT_DIR/../../packages/cli/src/fly/main.ts" ]]; then
    exec bun run "$SCRIPT_DIR/../../packages/cli/src/fly/main.ts" zeroclaw "$@"
fi
