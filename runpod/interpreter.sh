...
log_info "Open Interpreter on RunPod"
echo ""
...
run_server "${RUNPOD_POD_ID}" "pip install open-interpreter 2>/dev/null || pip3 install open-interpreter"
...
sleep 1
clear
interactive_session "${RUNPOD_POD_ID}" "source ~/.zshrc && interpreter"
