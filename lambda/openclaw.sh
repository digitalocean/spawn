...
log_info "OpenClaw on Lambda Cloud"
echo ""
...
run_server "$LAMBDA_SERVER_IP" "rm -rf ~/.openclaw && mkdir -p ~/.openclaw"
...
upload_file "$LAMBDA_SERVER_IP" "$OPENCLAW_CONFIG_TEMP" "/home/ubuntu/.openclaw/openclaw.json"
